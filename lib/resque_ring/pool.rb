module ResqueRing
  class Pool
    ...
    def deregister(worker)
      puts "removing worker #{worker.pid} from registry..."
    ...
    def spawn!
      ...
      puts "spawned worker: #{worker.pid}"
    end
